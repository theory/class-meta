...
# $Id: Class.pm,v 1.18 2004/01/08 07:02:27 david Exp $
...
=head1 SYNOPSIS
  ...
  print "Examing object of class ", $class->my_package, $/;

  print "\nConstructors:\n";
  for my $ctor ($class->my_ctors) {
      print "  o ", $ctor->my_name, $/;
  }
  ...
  print "\nMethods:\n";
  for my $meth ($class->my_meths) {
      print "  o ", $meth->my_name, $/;
  }
...
C<< $class->my_package->isa($pkg) >>, but more efficient.
